            ...
            <div style={{ height: 'auto' }} className='my-5'>
                <div className='row home-row2 home-row3 flex-lg-row flex-sm-column-reverse justify-content-center align-items-center'>
                    <div className='col-lg-6 col-sm-12' style={{ textAlign: "left", padding: "20px" }}>
                        ...
                        <br />
                        <div>
                            <p>Ultimately, a great painting is the result of the artist's dedication to their craft and their commitment to creating a work of lasting beauty and quality. It is a testament to their skill, creativity, and ability to connect with the viewer through their art..</p>
                        </div>
                    </div>
